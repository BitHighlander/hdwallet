...
export class PioneerAdapter {
  ...
  private constructor (keyring: Keyring, args: { pioneer?: PioneerWallet, pioneerAppId?: string }) {
    this.pioneer = {}
    this.pioneerAppId = "Pioneer 001"
    this.keyring = keyring
  }

  public static useKeyring (keyring: Keyring, args: { pioneer?: PioneerWallet, pioneerAppId?: string }) {
