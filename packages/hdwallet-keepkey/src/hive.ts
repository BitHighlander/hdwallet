...
export class HiveGetPublicKeys extends jspb.Message {
  ...
  getAccountIndex(): number { return jspb.Message.getFieldWithDefault(this, 1, 0) as number; }
  setAccountIndex(value: number): void { jspb.Message.setField(this, 1, value); }
  ...
  toObject(): object { return { accountIndex: this.getAccountIndex(), showDisplay: this.getShowDisplay() }; }
  static toObject(_: boolean, msg: HiveGetPublicKeys): object { return msg.toObject(); }
  ...
  static deserializeBinaryFromReader(msg: HiveGetPublicKeys, reader: jspb.BinaryReader): HiveGetPublicKeys {
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1: msg.setAccountIndex(reader.readUint32()); break;
        case 2: msg.setShowDisplay(reader.readBool()); break;
        default: reader.skipField();
      }
    }
...
export class HivePublicKeys extends jspb.Message {
  ...
  getOwnerKey(): string { return jspb.Message.getFieldWithDefault(this, 1, "") as string; }
  setOwnerKey(value: string): void { jspb.Message.setField(this, 1, value); }
  getActiveKey(): string { return jspb.Message.getFieldWithDefault(this, 2, "") as string; }
  setActiveKey(value: string): void { jspb.Message.setField(this, 2, value); }
  getMemoKey(): string { return jspb.Message.getFieldWithDefault(this, 3, "") as string; }
  setMemoKey(value: string): void { jspb.Message.setField(this, 3, value); }
  getPostingKey(): string { return jspb.Message.getFieldWithDefault(this, 4, "") as string; }
  setPostingKey(value: string): void { jspb.Message.setField(this, 4, value); }
  ...
  toObject(): object {
    return {
      ownerKey: this.getOwnerKey(), activeKey: this.getActiveKey(),
      memoKey: this.getMemoKey(), postingKey: this.getPostingKey(),
    };
  }
  static toObject(_: boolean, msg: HivePublicKeys): object { return msg.toObject(); }
  ...
  static deserializeBinaryFromReader(msg: HivePublicKeys, reader: jspb.BinaryReader): HivePublicKeys {
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1: msg.setOwnerKey(reader.readString()); break;
        case 2: msg.setActiveKey(reader.readString()); break;
        case 3: msg.setMemoKey(reader.readString()); break;
        case 4: msg.setPostingKey(reader.readString()); break;
        default: reader.skipField();
      }
    }
    return msg;
  ...
  static serializeBinaryToWriter(message: HivePublicKeys, writer: jspb.BinaryWriter): void {
    for (const [field, getter] of [[1, "getOwnerKey"], [2, "getActiveKey"], [3, "getMemoKey"], [4, "getPostingKey"]] as const) {
...
export class HiveSignAccountCreate extends jspb.Message {
  ...
  getExpiration(): number { return jspb.Message.getFieldWithDefault(this, 5, 0) as number; }
  setExpiration(value: number): void { jspb.Message.setField(this, 5, value); }
  getCreator(): string { return jspb.Message.getFieldWithDefault(this, 6, "") as string; }
  setCreator(value: string): void { jspb.Message.setField(this, 6, value); }
  getNewAccountName(): string { return jspb.Message.getFieldWithDefault(this, 7, "") as string; }
  setNewAccountName(value: string): void { jspb.Message.setField(this, 7, value); }
  getOwnerKey(): string { return jspb.Message.getFieldWithDefault(this, 8, "") as string; }
  setOwnerKey(value: string): void { jspb.Message.setField(this, 8, value); }
  getActiveKey(): string { return jspb.Message.getFieldWithDefault(this, 9, "") as string; }
  setActiveKey(value: string): void { jspb.Message.setField(this, 9, value); }
  getPostingKey(): string { return jspb.Message.getFieldWithDefault(this, 10, "") as string; }
  setPostingKey(value: string): void { jspb.Message.setField(this, 10, value); }
  getMemoKey(): string { return jspb.Message.getFieldWithDefault(this, 11, "") as string; }
  setMemoKey(value: string): void { jspb.Message.setField(this, 11, value); }
  getFeeAmount(): number { return jspb.Message.getFieldWithDefault(this, 12, 0) as number; }
  setFeeAmount(value: number): void { jspb.Message.setField(this, 12, value); }
  ...
  toObject(): object {
    return {
      addressNList: this.getAddressNList(), chainId: this.getChainId(),
      refBlockNum: this.getRefBlockNum(), refBlockPrefix: this.getRefBlockPrefix(),
      expiration: this.getExpiration(), creator: this.getCreator(),
      newAccountName: this.getNewAccountName(), ownerKey: this.getOwnerKey(),
      activeKey: this.getActiveKey(), postingKey: this.getPostingKey(),
      memoKey: this.getMemoKey(), feeAmount: this.getFeeAmount(),
    };
  }
  static toObject(_: boolean, msg: HiveSignAccountCreate): object { return msg.toObject(); }
  ...
  static deserializeBinaryFromReader(msg: HiveSignAccountCreate, reader: jspb.BinaryReader): HiveSignAccountCreate {
    while (reader.nextField()) {
      ...
      switch (reader.getFieldNumber()) {
        ...
        case 4: msg.setRefBlockPrefix(reader.readUint32()); break;
        case 5: msg.setExpiration(reader.readUint32()); break;
        case 6: msg.setCreator(reader.readString()); break;
        case 7: msg.setNewAccountName(reader.readString()); break;
        case 8: msg.setOwnerKey(reader.readString()); break;
        case 9: msg.setActiveKey(reader.readString()); break;
        case 10: msg.setPostingKey(reader.readString()); break;
        case 11: msg.setMemoKey(reader.readString()); break;
        case 12: msg.setFeeAmount(reader.readUint64()); break;
        default: reader.skipField();
      }
    }
    return msg;
...
export class HiveSignAccountUpdate extends jspb.Message {
  ...
  getExpiration(): number { return jspb.Message.getFieldWithDefault(this, 5, 0) as number; }
  setExpiration(value: number): void { jspb.Message.setField(this, 5, value); }
  getAccount(): string { return jspb.Message.getFieldWithDefault(this, 6, "") as string; }
  setAccount(value: string): void { jspb.Message.setField(this, 6, value); }
  getNewOwnerKey(): string { return jspb.Message.getFieldWithDefault(this, 7, "") as string; }
  setNewOwnerKey(value: string): void { jspb.Message.setField(this, 7, value); }
  getNewActiveKey(): string { return jspb.Message.getFieldWithDefault(this, 8, "") as string; }
  setNewActiveKey(value: string): void { jspb.Message.setField(this, 8, value); }
  getNewPostingKey(): string { return jspb.Message.getFieldWithDefault(this, 9, "") as string; }
  setNewPostingKey(value: string): void { jspb.Message.setField(this, 9, value); }
  getNewMemoKey(): string { return jspb.Message.getFieldWithDefault(this, 10, "") as string; }
  setNewMemoKey(value: string): void { jspb.Message.setField(this, 10, value); }
  ...
  toObject(): object {
    return {
      addressNList: this.getAddressNList(), chainId: this.getChainId(),
      refBlockNum: this.getRefBlockNum(), refBlockPrefix: this.getRefBlockPrefix(),
      expiration: this.getExpiration(), account: this.getAccount(),
      newOwnerKey: this.getNewOwnerKey(), newActiveKey: this.getNewActiveKey(),
      newPostingKey: this.getNewPostingKey(), newMemoKey: this.getNewMemoKey(),
    };
  }
  static toObject(_: boolean, msg: HiveSignAccountUpdate): object { return msg.toObject(); }
  ...
  static deserializeBinaryFromReader(msg: HiveSignAccountUpdate, reader: jspb.BinaryReader): HiveSignAccountUpdate {
    while (reader.nextField()) {
      ...
      switch (reader.getFieldNumber()) {
        ...
        case 4: msg.setRefBlockPrefix(reader.readUint32()); break;
        case 5: msg.setExpiration(reader.readUint32()); break;
        case 6: msg.setAccount(reader.readString()); break;
        case 7: msg.setNewOwnerKey(reader.readString()); break;
        case 8: msg.setNewActiveKey(reader.readString()); break;
        case 9: msg.setNewPostingKey(reader.readString()); break;
        case 10: msg.setNewMemoKey(reader.readString()); break;
        default: reader.skipField();
      }
    }
    return msg;
...
export class HiveSignedAccountCreate extends jspb.Message {
  ...
  toObject(): object { return { signature: this.getSignature_asU8(), serializedTx: this.getSerializedTx_asU8() }; }
  static toObject(_: boolean, msg: HiveSignedAccountCreate): object { return msg.toObject(); }
...
export class HiveSignedAccountUpdate extends jspb.Message {
  ...
  toObject(): object { return { signature: this.getSignature_asU8(), serializedTx: this.getSerializedTx_asU8() }; }
  static toObject(_: boolean, msg: HiveSignedAccountUpdate): object { return msg.toObject(); }
