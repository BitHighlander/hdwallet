...
// Cast to access runtime-only jspb.Message methods
...
class EthereumTxMetadata extends jspb.Message {
  ...
  static serializeBinaryToWriter(message: EthereumTxMetadata, writer: jspb.BinaryWriter): void {
    ...
    const version = message.getMetadataVersion();
    if (version !== 1) writer.writeUint32(2, version);
  ...
  static deserializeBinary(bytes: Uint8Array): EthereumTxMetadata {
    ...
    while (reader.nextField()) {
      ...
      switch (reader.getFieldNumber()) {
        case 1: msg.setSignedPayload(reader.readBytes()); break;
        case 2: msg.setMetadataVersion(reader.readUint32()); break;
        case 3: msg.setKeyId(reader.readUint32()); break;
...
class EthereumMetadataAck extends jspb.Message {
  ...
  static deserializeBinary(bytes: Uint8Array): EthereumMetadataAck {
    ...
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1: jspb.Message.setField(msg, 1, reader.readUint32()); break;
        case 2: jspb.Message.setField(msg, 2, reader.readString()); break;
        default: reader.skipField(); break;
      }
    }
    return msg;
  ...
  return transport.lockDuring(async () => {
    ...
    if (msg.txMetadata?.signedPayload) {
      ...
      try {
        ...
        // 0=OPAQUE (blob invalid/unsigned), 1=VERIFIED, 2=MALFORMED
        console.log(
          `[hdwallet] EthereumTxMetadata response: classification=${classification}` +
