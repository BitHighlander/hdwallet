import { Keyring, HDWallet, Events, PopupClosedError } from '@bithighlander/hdwallet-core';
import { create as createTrezor, TrezorHDWallet } from '@bithighlander/hdwallet-trezor'
