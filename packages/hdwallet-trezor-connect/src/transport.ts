import { Events, makeEvent, Keyring, HDWalletErrorType, ActionCancelled } from "@bithighlander/hdwallet-core";
import { TrezorHDWallet, TrezorTransport, TrezorConnectResponse } from "@bithighlander/hdwallet-trezor";
